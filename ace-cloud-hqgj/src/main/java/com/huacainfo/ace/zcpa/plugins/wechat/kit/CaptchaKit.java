package com.huacainfo.ace.zcpa.plugins.wechat.kit;
...
public class CaptchaKit {
    ...
    protected static Logger logger = LoggerFactory.getLogger(CaptchaKit.class);
     ...
     * @since 1.0.0
     */
    public static final String createRandomStr(int iLen, int iType) {
    ...
    public void getRandCode(HttpServletRequest request,
        ...
        //将生成的随机字符串保存到session中，而jsp界面通过session.getAttribute("RANDOM_CODE_KEY")，
     ...
     * 绘制字符串
     */
    public String drawString(Graphics g, String randomString, int i) {
        g.setFont(getFont());
