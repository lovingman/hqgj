...
import com.huacainfo.ace.hqgj.plugins.wechat.WeChatTemplateMsgApi;
...
import com.huacainfo.ace.hqgj.service.WechatTemplateMsgService;
...
public class WechatTemplateMsgServiceImpl implements WechatTemplateMsgService {
    ...
    public ResponseDTO notice(String openid,
        ...
        if(CommonUtils.isBlank(accessToken)){
            return new ResponseDTO(ResultCode.SUCCESS, "获取AccessToken失败" );
        }
        //发送接口调用
    ...
    private String getAccessToken() {
        WechatConfig config = configDao.findBySysId();
