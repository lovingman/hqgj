...
import com.huacainfo.ace.wxms.wechat.constant.ApiUrlConstant;
import com.huacainfo.ace.wxms.wechat.constant.WxApiRtnCode;
import com.huacainfo.ace.wxms.wechat.entity.UserList;
import com.huacainfo.ace.wxms.wechat.entity.pojo.base.Menu;
import com.huacainfo.ace.wxms.wechat.entity.pojo.resp.AccessTokenResp;
import com.huacainfo.ace.wxms.wechat.entity.pojo.resp.TicketResp;
...
public class WeChatApi {
    ...
    public static ResponseDTO<WechatConfig> getAccessToken(String appId, String appSecret) {
        ...
        //获取授权页ticket失败,结果返回
        if (ticket.getErrcode() != WxApiRtnCode.OK_0) {
    ...
    public static String createMenu(String accessToken, Menu menu) {
        ...
        return HttpKit.post(url, menu.toString());
