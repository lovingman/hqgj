  ...
  <div class="container">
    <div class="table">
      <div class="handle-box">
        <el-row>
          <el-col :span="12" v-if="userBtn['/hqgj/baseCompany/create']">
            <el-button @click="create" style="float: left;border-radius:5px;" type="primary">创建</el-button>
          </el-col>
          <el-col :span="12" v-else="userBtn['/hqgj/baseCompany/create']">&nbsp;</el-col>
          <!--<el-col :span="14">-->
      ...
      >
        ...
        <el-table-column label="企业名称" :show-overflow-tooltip="true" prop="companyName" width="300"></el-table-column>
        ...
        <el-table-column label="法人代表" prop="legalPerson" width="100"></el-table-column>
        ...
        <el-table-column align="right" fixed="right" header-align="center" label="操作" width="200">
          <template slot-scope="scope">
            <el-button
              @click="person(scope.$index,scope.row)"
              v-if="userBtn['/hqgj/baseCompanyMember/page']"
              height="40"
              type="text"
            >员工管理</el-button>
            <span class="strightline" v-if="userBtn['/hqgj/baseCompanyMember/page']">|</span>
            <el-button
              @click="edit(scope.$index,scope.row)"
              v-if="userBtn['/hqgj/baseCompany/update']"
              height="40"
              type="text"
            >编辑</el-button>
            <span class="strightline" v-if="userBtn['/hqgj/baseCompany/update']">|</span>
            <el-button
              @click="handleDelete(scope.$index,scope.row)"
              v-if="userBtn['/hqgj/baseCompany/deleteById']"
              type="text"
            >删除</el-button>
            <span class="strightline" v-if="userBtn['/hqgj/baseCompany/deleteById']">|</span>
...
export default {
  ...
  methods: {
    ...
    person(index, data) {
      this.$router.push({
        path: "/hqgj/BasicData/enterprise/Member",
        query: { id: data.id }
      });
    },
    create() {
    ...
    edit(index, data) {
      this.$router.push({
        path: "/hqgj/BasicData/enterprise/edit",
        query: { id: data.id }
      });
    },
    preview(index, data) {
      this.$router.push({
        path: "/hqgj/BasicData/enterprise/details",
        query: { id: data.id }
      });
    },
    //删除
