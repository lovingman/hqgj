<template>
    <div class="main-box">
        <div class="header">
            <el-row>
                <el-col :span="12"  v-if="userBtn['/hqgj/lawPolicy/create']">
                    <el-button @click="create" style="float:left;" type="primary">创建
                    </el-button>
                </el-col>
                <el-col :span="12" v-else="userBtn['/hqgj/lawPolicy/create']">&nbsp;</el-col>
                <el-col :span="6">
                ...
                <el-table-column align="right" fixed="right" header-align="center" label="操作" width="200">
                    <template slot-scope="scope">
                        ...
                        <el-button @click="edit(scope.$index,scope.row)" type="text"
                                   v-if="userBtn['/hqgj/lawPolicy/update']">编辑
                        </el-button>
                        <el-button @click="handleDele(scope.$index,scope.row)"
                                   type="text" v-if="userBtn['/hqgj/lawPolicy/deleteById']">删除
                        </el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            edit(index, data) {
                this.$router.push({
                    path: "/hqgj/Policies/OtrlPolicy/edit",
                    query: {id: data.id}
                });
            },
            //详情
            preview(index, data) {
                this.$router.push({
                    path: "/hqgj/Policies/OtrlPolicy/details",
                    query: {id: data.id}
                });
            }
        }
