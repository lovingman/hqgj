        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="标题" prop="title">
              <el-input clearable maxlength="200" placeholder="请输入标题" show-word-limit v-model.trim="serviceForm.title">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="来源">
              <el-input clearable maxlength="50" placeholder="请输入来源" show-word-limit v-model.trim="serviceForm.source">
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="文件" prop="fileList">
              <el-upload :before-upload="beforeAvatarUpload" :file-list="serviceForm.fileList"
                :http-request="uploadServer" :on-remove="fileRemove" action="none" class="upload-demo" drag multiple>
    ...
    methods: {
      ...
      initCKEditor() {
        ...
        CKEditor.create(document.querySelector("#editor"), {
            language: "zh-cn",
            removePlugins: ["MediaEmbed", 'link'], //除去视频按钮
