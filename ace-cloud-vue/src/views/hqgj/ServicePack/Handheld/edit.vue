        ...
        <div class="content-box">
            ...
            >
                <el-row>
                    ...
                    >选择该类型，用户支付费用通过应付费用=500积分+支付费用的方式，抵扣的积分将返现给服务机构,500积分=500元
                    </div>
                    <div class="ties" v-if="serviceForm.type == 3">选择该类型，用户可免费享受咨询服务</div>
                </el-row>
                <!-- 代理财政是否显示 -->
                <div class="show-box" v-if="this.serviceForm.type != ''">
                    <el-row>
                        <el-col :span="12">
                        ...
                        <el-col :span="12" v-if="serviceForm.type == 3">
                            <el-form-item label="名额：" prop="quota">
                                <el-input clearable placeholder="请输入免费咨询名额" v-model="serviceForm.quota"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="12" v-if="serviceForm.type == 3">
                            <el-form-item label="地点：" prop="address">
                                <el-input clearable placeholder="请输入地点" v-model="serviceForm.address"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                            ...
                            <div class="project-item-box">
                                ...
                                >
                                    ...
                                    <el-col :span="12">
                                        ...
                                        >
                                            <el-input clearable placeholder="请输入价格" v-model="domain.price"></el-input>
                                        </el-form-item>
                                    </el-col>
                                </div>
                            </div>
