  ...
  <div class="container">
    <div class="table">
      ...
      <el-table :data="list" class="table" max-height="475" ref="multipleTable" v-loading="loading">
        ...
        <el-table-column width="150" label="获得积分" prop="getIntegral"></el-table-column>
        <el-table-column label="剩余积分" prop="surplusIntegral" width="150"></el-table-column>
        <el-table-column label="创建时间" prop="createDate" width="250"></el-table-column>
