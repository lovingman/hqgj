  ...
  <div class="main-box">
      ...
      <el-row>
        <el-col class="selectSearch" :span="10">
          ...
          <el-col :span="16" :offset="1">
            <el-input placeholder="请输入企业名称或姓名" v-model.trim="query.companyName" clearable class="input-with-select">
    ...
    <div class="table-box">
      <el-table :data="tableData" max-height="475" style="width: 100%" v-loading="loading" element-loading-text="加载中"
        ...
        <el-table-column label="操作" fixed="right" width="200" align="right" header-align="center" class="right-txt">
          <template slot-scope="scope">
