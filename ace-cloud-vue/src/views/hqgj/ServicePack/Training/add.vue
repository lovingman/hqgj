    ...
    <el-tabs :class="{noClick:noClickTabs}" v-model="tabsName">
      <el-tab-pane label="基本信息" name="first">
        <div class="content-box">
          ...
          <el-form :inline="true" :model="basicForm" :rules="basicRules" class="formBox" label-width="120px"
            ref="basicForm">
            <el-row>
              <el-col :span="12">
                <el-form-item label="机构：" prop="orgId">
                  <el-select :disabled="disabled" @change="changeOrg" clearable placeholder="请选择机构"
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="标题：" prop="title">
                  <el-input clearable maxlength="50" placeholder="请输入标题" show-word-limit v-model.trim="basicForm.title">
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="人数：" prop="cultivatePersonNumber">
                  <el-input clearable placeholder="请输入最多可报名人数" v-model.trim="basicForm.cultivatePersonNumber">
                  </el-input>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="12">
                <el-form-item label="时间：" prop="timeArr">
                  <el-date-picker end-placeholder="结束日期" range-separator="至" start-placeholder="开始日期"
                    type="datetimerange" v-model="basicForm.timeArr"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="地点：" prop="detailedAddress" class="address-box">
      ...
      <el-tab-pane label="日程安排" name="second">
        <div class="content-box">
          ...
          <el-form :inline="true" :model="scheduleForm" :rules="scheduleRules" class="formBox scheduleBox"
            label-width="120px" ref="scheduleForm">
            <div :key="scheduleModel.key" class="memberModel"
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item :key="scheduleModel.key" :label="'名称：'" :prop="'scheduleModels.'+index+'.title'"
                    :rules="scheduleRules.title">
                    <el-input maxlength="50" placeholder="请输入培训名称" show-word-limit type="text"
                      v-model.trim="scheduleModel.title"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item :key="scheduleModel.key" :label="'讲师：'" :prop="'scheduleModels.'+index+'.lecturerId'"
                    :rules="scheduleRules.lecturerId">
                    <el-select @change="changeLecturer($event,index)" clearable placeholder="请选择讲师"
                      v-model="scheduleModel.lecturerId">
                      <el-option :key="item.id" :label="item.name" :value="item.id" v-for="item in lecturerArr">
                      </el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item :key="scheduleModel.key" :label="'地点：'"
                    :prop="'scheduleModels.'+index+'.detailedAddress'" :rules="scheduleRules.detailedAddress">
                    <el-input maxlength="50" placeholder="请输入详细地址" show-word-limit type="text"
                      v-model.trim="scheduleModel.detailedAddress"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item :key="scheduleModel.key" :label="'时间：'" :prop="'scheduleModels.'+index+'.timeArr'"
                    :rules="scheduleRules.timeArr">
                    <el-date-picker end-placeholder="结束日期" range-separator="至" start-placeholder="开始日期"
                      type="datetimerange" v-model="scheduleModel.timeArr"></el-date-picker>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-form-item :key="scheduleModel.key" :label="'简介：'" :prop="'scheduleModels.'+index+'.content'"
                  :rules="scheduleRules.content">
                  <el-input :rows="8" maxlength="200" placeholder="简要概述培训内容，不超过200字" show-word-limit type="textarea"
                    v-model.trim="scheduleModel.content"></el-input>
                </el-form-item>
              </el-row>
              <el-row>
                <el-form-item :label="'课件：'" :prop="'scheduleModels.'+index+'.courseware'">
                  <div @click="getImageTypeIndex(index)">
                    <el-upload :before-upload="beforeAvatarUpload" :file-list="showList[index].fileArr"
                      :http-request="uploadServer" :before-remove="fileRemove" action="none" class="upload-demo"
                      multipl>
            ...
            <el-button @click="addSchedule" style="margin-top:20px;margin-left:120px;" type="primary">
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            ...
            let serveCultivate = {
              ...
              startDate: this.basicForm.timeArr.length > 0 ?
                this.basicForm.timeArr[0] : "", //开始时间
              endDate: this.basicForm.timeArr.length > 0 ?
                this.basicForm.timeArr[1] : "", //结束时间
