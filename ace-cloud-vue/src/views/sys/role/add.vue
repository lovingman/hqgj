  ...
  <div class="app-container">
    <el-card shadow="never">
      <el-container>
        ...
        <el-main v-loading="loading" element-loading-text="请求中" element-loading-spinner="el-icon-loading">
          <el-form :rules="rules" ref="ruleForm" :model="form" label-width="80px" style="width:50%">
            ...
            <el-form-item label="角色类型" prop="type">
              <el-select v-model="form.type" placeholder="请选择单位类型" style="width:100%">
                <el-option v-for="item in dict['40']" :key="item.code" :label="item.name" :value="item.code">
                </el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="归属系统" prop="syid">
              <el-select v-model="form.syid" placeholder="请选择归属系统" style="width:100%">
                <el-option v-for="item in dict['41']" :key="item.code" :label="item.name" :value="item.code">
                </el-option>
              </el-select>
            </el-form-item>
