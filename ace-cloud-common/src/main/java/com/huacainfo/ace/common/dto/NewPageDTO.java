 ...
 * @Description 使用PageHelper插件用到的分页数据对象类
 * @Author Arvin Zou
 * @Date 2019/5/31 15:17
 */
public class NewPageDTO<T> extends ResponseDTO {
    ...
    public NewPageDTO(List<T> list) {
        this(list, 8);
    }

    public NewPageDTO(List<T> list, int navigatePages) {
        this.isFirstPage = false;
        this.isLastPage = false;
        this.hasPreviousPage = false;
        this.hasNextPage = false;
